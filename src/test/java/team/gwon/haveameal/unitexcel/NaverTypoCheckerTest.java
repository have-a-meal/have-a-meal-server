...
public class NaverTypoCheckerTest {
	...
	public void test() throws JsonProcessingException, UnsupportedEncodingException {
		String beforeWord = "닥고기계란장조림";
		String beforeWord2 = "배추기치";
		// String text1 = URLEncoder.encode(beforeWord, "UTF-8");
		// String text2 = URLEncoder.encode(beforeWord2, "UTF-8");
		log.info("success {} to {}", beforeWord, typoChecker(beforeWord, beforeWord2));
	}
	...
	private static String typoChecker(String word, String word2) throws JsonProcessingException {
		...
		//ex)마라상거->마라샹거->마라샹궈
		try {
			text = URLEncoder.encode(word, "UTF-8") + "," + URLEncoder.encode(word2, "UTF-8");
